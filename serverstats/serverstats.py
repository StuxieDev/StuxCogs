...
class ServerStats(commands.Cog):
    """
    Gather useful information about the server
    Most commands are private and can only be used by the bot developer
    ...
    @commands.command(name="emojiutil")
    async def emoji(
    ...
    @commands.command(name="channelslist")
    @checks.is_owner()
    async def channelslist(self, ctx: commands.Context, *, guild: GuildConverter = None) -> None:
        """
